    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center">
          ...
          <Link to="/apis">
            <Button size="large" className="bg-purple-600 hover:bg-purple-700 text-white px-8 py-3 text-lg">
              Get started
            </Button>
          </Link>
        </div>
          ...
          <div className="bg-gradient-to-r from-purple-600 via-blue-600 to-purple-800 rounded-lg p-8 relative overflow-hidden">
            ...
            <div className="relative z-10 h-64 flex items-center justify-center">
              <div className="text-white text-center">
                <h2 className="text-3xl font-bold mb-4">Explore our APIs</h2>
                <p className="text-purple-100 text-lg">Discover powerful APIs to enhance your applications</p>
              </div>
            </div>
          </div>
        </div>
